...
This software and associated documentation files (the "Software") are proprietary and confidential. The Software is licensed, not sold, to you for use only under the terms of this license agreement.

### Permitted Use

Subject to the terms and conditions of this Agreement and payment of applicable license fees, you are granted a limited, non-exclusive, non-transferable, revocable license to:

1. Install and use the Software on devices owned or controlled by you
2. Use the Software for its intended purpose as described in the documentation
3. Make one backup copy of the Software for archival purposes only

### Restrictions

You may NOT:

1. **Distribute** - Copy, distribute, publish, transfer, sublicense, lease, lend, or rent the Software to any third party
2. **Modify** - Reverse engineer, decompile, disassemble, or attempt to derive the source code of the Software
3. **Share** - Share your license key or credentials with any other person or entity
4. **Create Derivative Works** - Modify, adapt, translate, or create derivative works based on the Software
5. **Remove Notices** - Remove, alter, or obscure any proprietary notices, labels, or marks on the Software
6. **Commercial Redistribution** - Use the Software as part of a service offering or redistribute it commercially
7. **Benchmark** - Conduct or publish any benchmarking or comparative analysis without prior written consent
...
All title, ownership rights, and intellectual property rights in and to the Software remain with Noam F. The Software is protected by copyright laws and international treaty provisions. This license does not grant you any rights to trademarks, service marks, or trade names.
...
2. Not disclose any portion of the Software to third parties
3. Protect the Software with at least the same degree of care used to protect your own confidential information
...
- Support is limited to the current version and one prior major version
...
- The Software is compatible with any particular hardware or software platform
...
**THE MAXIMUM LIABILITY OF THE LICENSOR SHALL NOT EXCEED THE LICENSE FEES PAID BY YOU IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.**

Some jurisdictions do not allow the exclusion or limitation of incidental or consequential damages, so the above limitation may not apply to you.

## Data Collection and Privacy

The Software may collect usage statistics and error reports to improve functionality. No personally identifiable information is collected without explicit consent. For details, see the Privacy Policy at [privacy-policy-url].

## Export Compliance

You agree to comply with all applicable export and import laws and regulations. You will not export, re-export, or transfer the Software to any prohibited country, entity, or person.

## Audit Rights

The licensor reserves the right to audit your use of the Software to ensure compliance with this Agreement. Such audits will be conducted with reasonable notice during normal business hours.

## Third-Party Components

The Software may include third-party open source components, each subject to its own license terms. A list of such components and their licenses is available in the THIRD_PARTY_LICENSES.md file.
...
**IF YOU DO NOT AGREE TO THE TERMS OF THIS AGREEMENT, DO NOT INSTALL OR USE THE SOFTWARE AND PROMPTLY RETURN OR DESTROY ALL COPIES.**
